...
function Localisation() {
	return (
		<div
			...
			<div className='flex padding-container mt-[50px] justify-between'>
				<div className='w-1/2 text-justify'>
					...
					<div className=''>
						<button className='w-[40%] flex justify-between items-center gap-4 text-[#4097FF] border border-[#4097FF] p-3 rounded-full px-8'>
							<a href=''>Comment s’y rendre ?</a>
							<CircleChevronRight />
						</button>
					</div>
				</div>
				<div className='relative w-1/3 h-[600px] rounded-4xl shadow-lg'>
					<img
						src={Map}
						alt='Map'
